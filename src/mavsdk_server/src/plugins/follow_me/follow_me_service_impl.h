...
public:
        ...
        rpc::follow_me::GetConfigResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "GetConfig sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }

        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->get_config();
        ...
        rpc::follow_me::SetConfigResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_config(translateFromRpcConfig(request->config()));
        ...
        rpc::follow_me::SetTargetLocationResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_target_location(translateFromRpcTargetLocation(request->location()));
        ...
        rpc::follow_me::GetLastLocationResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "GetLastLocation sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }

        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->get_last_location();
