...
public:
        ...
        rpc::log_files::GetEntriesResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "GetEntries sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }

        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->get_entries();
    ...
    grpc::Status SubscribeDownloadLogFile(grpc::ServerContext* /* context */, const mavsdk::rpc::log_files::SubscribeDownloadLogFileRequest* request, grpc::ServerWriter<rpc::log_files::DownloadLogFileResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->download_log_file_async(translateFromRpcEntry(request->entry()), request->path(), 
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](mavsdk::LogFiles::Result result,const mavsdk::LogFiles::ProgressData download_log_file) {
        ...
        rpc::log_files::DownloadLogFileResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->download_log_file(translateFromRpcEntry(request->entry()), request->path());
        ...
        rpc::log_files::EraseAllLogFilesResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "EraseAllLogFiles sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->erase_all_log_files();
