...
public:
        ...
        rpc::failure::InjectResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->inject(translateFromRpcFailureUnit(request->failure_unit()), translateFromRpcFailureType(request->failure_type()), request->instance());
