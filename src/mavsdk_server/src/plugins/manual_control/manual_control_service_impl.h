...
public:
        ...
        rpc::manual_control::StartPositionControlResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "StartPositionControl sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->start_position_control();
        ...
        rpc::manual_control::StartAltitudeControlResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "StartAltitudeControl sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->start_altitude_control();
        ...
        rpc::manual_control::SetManualControlInputResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_manual_control_input(request->x(), request->y(), request->z(), request->r());
