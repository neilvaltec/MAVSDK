...
public:
        ...
        rpc::param_server::RetrieveParamIntResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->retrieve_param_int(request->name());
        ...
        rpc::param_server::ProvideParamIntResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->provide_param_int(request->name(), request->value());
        ...
        rpc::param_server::RetrieveParamFloatResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->retrieve_param_float(request->name());
        ...
        rpc::param_server::ProvideParamFloatResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->provide_param_float(request->name(), request->value());
        ...
        rpc::param_server::RetrieveParamCustomResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->retrieve_param_custom(request->name());
        ...
        rpc::param_server::ProvideParamCustomResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->provide_param_custom(request->name(), request->value());
        ...
        rpc::param_server::RetrieveAllParamsResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "RetrieveAllParams sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }

        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->retrieve_all_params();
