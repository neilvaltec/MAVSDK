...
public:
    ...
    grpc::Status SubscribeTransponder(grpc::ServerContext* /* context */, const mavsdk::rpc::transponder::SubscribeTransponderRequest* request, grpc::ServerWriter<rpc::transponder::TransponderResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_transponder(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const mavsdk::Transponder::AdsbVehicle transponder) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_transponder(nullptr);
        ...
        rpc::transponder::SetRateTransponderResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_rate_transponder(request->rate_hz());
