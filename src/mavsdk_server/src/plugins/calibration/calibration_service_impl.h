...
public:
    ...
    grpc::Status SubscribeCalibrateGyro(grpc::ServerContext* /* context */, const mavsdk::rpc::calibration::SubscribeCalibrateGyroRequest* request, grpc::ServerWriter<rpc::calibration::CalibrateGyroResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->calibrate_gyro_async(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](mavsdk::Calibration::Result result,const mavsdk::Calibration::ProgressData calibrate_gyro) {
    ...
    grpc::Status SubscribeCalibrateAccelerometer(grpc::ServerContext* /* context */, const mavsdk::rpc::calibration::SubscribeCalibrateAccelerometerRequest* request, grpc::ServerWriter<rpc::calibration::CalibrateAccelerometerResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->calibrate_accelerometer_async(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](mavsdk::Calibration::Result result,const mavsdk::Calibration::ProgressData calibrate_accelerometer) {
    ...
    grpc::Status SubscribeCalibrateMagnetometer(grpc::ServerContext* /* context */, const mavsdk::rpc::calibration::SubscribeCalibrateMagnetometerRequest* request, grpc::ServerWriter<rpc::calibration::CalibrateMagnetometerResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->calibrate_magnetometer_async(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](mavsdk::Calibration::Result result,const mavsdk::Calibration::ProgressData calibrate_magnetometer) {
    ...
    grpc::Status SubscribeCalibrateLevelHorizon(grpc::ServerContext* /* context */, const mavsdk::rpc::calibration::SubscribeCalibrateLevelHorizonRequest* request, grpc::ServerWriter<rpc::calibration::CalibrateLevelHorizonResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->calibrate_level_horizon_async(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](mavsdk::Calibration::Result result,const mavsdk::Calibration::ProgressData calibrate_level_horizon) {
    ...
    grpc::Status SubscribeCalibrateGimbalAccelerometer(grpc::ServerContext* /* context */, const mavsdk::rpc::calibration::SubscribeCalibrateGimbalAccelerometerRequest* request, grpc::ServerWriter<rpc::calibration::CalibrateGimbalAccelerometerResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->calibrate_gimbal_accelerometer_async(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](mavsdk::Calibration::Result result,const mavsdk::Calibration::ProgressData calibrate_gimbal_accelerometer) {
        ...
        rpc::calibration::CancelResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "Cancel sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->cancel();
