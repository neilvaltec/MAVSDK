...
public:
        ...
        rpc::gimbal::SetPitchAndYawResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_pitch_and_yaw(request->pitch_deg(), request->yaw_deg());
        ...
        rpc::gimbal::SetPitchRateAndYawRateResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_pitch_rate_and_yaw_rate(request->pitch_rate_deg_s(), request->yaw_rate_deg_s());
        ...
        rpc::gimbal::SetModeResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_mode(translateFromRpcGimbalMode(request->gimbal_mode()));
        ...
        rpc::gimbal::SetRoiLocationResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_roi_location(request->latitude_deg(), request->longitude_deg(), request->altitude_m());
        ...
        rpc::gimbal::TakeControlResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->take_control(translateFromRpcControlMode(request->control_mode()));
        ...
        rpc::gimbal::ReleaseControlResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->release_control();
    ...
    grpc::Status SubscribeControl(grpc::ServerContext* /* context */, const mavsdk::rpc::gimbal::SubscribeControlRequest* request, grpc::ServerWriter<rpc::gimbal::ControlResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_control(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const mavsdk::Gimbal::ControlStatus control) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_control(nullptr);
