...
public:
        ...
        rpc::mission::UploadMissionResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->upload_mission(translateFromRpcMissionPlan(request->mission_plan()));
    ...
    grpc::Status SubscribeUploadMissionWithProgress(grpc::ServerContext* /* context */, const mavsdk::rpc::mission::SubscribeUploadMissionWithProgressRequest* request, grpc::ServerWriter<rpc::mission::UploadMissionWithProgressResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->upload_mission_with_progress_async(translateFromRpcMissionPlan(request->mission_plan()), 
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](mavsdk::Mission::Result result,const mavsdk::Mission::ProgressData upload_mission_with_progress) {
        ...
        rpc::mission::CancelMissionUploadResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "CancelMissionUpload sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->cancel_mission_upload();
        ...
        rpc::mission::DownloadMissionResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "DownloadMission sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }

        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->download_mission();
    ...
    grpc::Status SubscribeDownloadMissionWithProgress(grpc::ServerContext* /* context */, const mavsdk::rpc::mission::SubscribeDownloadMissionWithProgressRequest* request, grpc::ServerWriter<rpc::mission::DownloadMissionWithProgressResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->download_mission_with_progress_async(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](mavsdk::Mission::Result result,const mavsdk::Mission::ProgressDataOrMission download_mission_with_progress) {
        ...
        rpc::mission::CancelMissionDownloadResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "CancelMissionDownload sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->cancel_mission_download();
        ...
        rpc::mission::StartMissionResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "StartMission sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->start_mission();
        ...
        rpc::mission::PauseMissionResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "PauseMission sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->pause_mission();
        ...
        rpc::mission::ClearMissionResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "ClearMission sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->clear_mission();
        ...
        rpc::mission::SetCurrentMissionItemResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_current_mission_item(request->index());
        ...
        rpc::mission::IsMissionFinishedResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "IsMissionFinished sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }

        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->is_mission_finished();
    ...
    grpc::Status SubscribeMissionProgress(grpc::ServerContext* /* context */, const mavsdk::rpc::mission::SubscribeMissionProgressRequest* request, grpc::ServerWriter<rpc::mission::MissionProgressResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_mission_progress(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const mavsdk::Mission::MissionProgress mission_progress) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_mission_progress(nullptr);
        ...
        rpc::mission::GetReturnToLaunchAfterMissionResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "GetReturnToLaunchAfterMission sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }

        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->get_return_to_launch_after_mission();
        ...
        rpc::mission::SetReturnToLaunchAfterMissionResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_return_to_launch_after_mission(request->enable());
