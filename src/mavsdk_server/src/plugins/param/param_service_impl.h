...
public:
        ...
        rpc::param::GetParamIntResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->get_param_int(request->name());
        ...
        rpc::param::SetParamIntResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_param_int(request->name(), request->value());
        ...
        rpc::param::GetParamFloatResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->get_param_float(request->name());
        ...
        rpc::param::SetParamFloatResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_param_float(request->name(), request->value());
        ...
        rpc::param::GetParamCustomResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->get_param_custom(request->name());
        ...
        rpc::param::SetParamCustomResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_param_custom(request->name(), request->value());
        ...
        rpc::param::GetAllParamsResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "GetAllParams sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }

        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->get_all_params();
