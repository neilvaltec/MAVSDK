...
public:
    ...
    grpc::Status SubscribeIncomingMission(grpc::ServerContext* /* context */, const mavsdk::rpc::mission_raw_server::SubscribeIncomingMissionRequest* request, grpc::ServerWriter<rpc::mission_raw_server::IncomingMissionResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_incoming_mission(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](mavsdk::MissionRawServer::Result result,const mavsdk::MissionRawServer::MissionPlan incoming_mission) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_incoming_mission(nullptr);
    ...
    grpc::Status SubscribeCurrentItemChanged(grpc::ServerContext* /* context */, const mavsdk::rpc::mission_raw_server::SubscribeCurrentItemChangedRequest* request, grpc::ServerWriter<rpc::mission_raw_server::CurrentItemChangedResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_current_item_changed(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const mavsdk::MissionRawServer::MissionItem current_item_changed) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_current_item_changed(nullptr);
        ...
        rpc::mission_raw_server::SetCurrentItemCompleteResponse* /* response */) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "SetCurrentItemComplete sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        
        _lazy_plugin.maybe_plugin(request->drone_id())->set_current_item_complete();
    ...
    grpc::Status SubscribeClearAll(grpc::ServerContext* /* context */, const mavsdk::rpc::mission_raw_server::SubscribeClearAllRequest* request, grpc::ServerWriter<rpc::mission_raw_server::ClearAllResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_clear_all(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const uint32_t clear_all) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_clear_all(nullptr);
