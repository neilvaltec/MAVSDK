...
public:
        ...
        rpc::offboard::StartResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->start();
        ...
        rpc::offboard::StopResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "Stop sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->stop();
        ...
        rpc::offboard::IsActiveResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "IsActive sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }

        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->is_active();
        ...
        rpc::offboard::SetAttitudeResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_attitude(translateFromRpcAttitude(request->attitude()));
        ...
        rpc::offboard::SetActuatorControlResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_actuator_control(translateFromRpcActuatorControl(request->actuator_control()));
        ...
        rpc::offboard::SetAttitudeRateResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_attitude_rate(translateFromRpcAttitudeRate(request->attitude_rate()));
        ...
        rpc::offboard::SetPositionNedResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_position_ned(translateFromRpcPositionNedYaw(request->position_ned_yaw()));
        ...
        rpc::offboard::SetPositionGlobalResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_position_global(translateFromRpcPositionGlobalYaw(request->position_global_yaw()));
        ...
        rpc::offboard::SetVelocityBodyResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_velocity_body(translateFromRpcVelocityBodyYawspeed(request->velocity_body_yawspeed()));
        ...
        rpc::offboard::SetVelocityNedResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_velocity_ned(translateFromRpcVelocityNedYaw(request->velocity_ned_yaw()));
        ...
        rpc::offboard::SetPositionVelocityNedResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_position_velocity_ned(translateFromRpcPositionNedYaw(request->position_ned_yaw()), translateFromRpcVelocityNedYaw(request->velocity_ned_yaw()));
        ...
        rpc::offboard::SetAccelerationNedResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_acceleration_ned(translateFromRpcAccelerationNed(request->acceleration_ned()));
