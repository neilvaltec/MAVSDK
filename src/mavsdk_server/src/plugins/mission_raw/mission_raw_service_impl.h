...
public:
        ...
        rpc::mission_raw::UploadMissionResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->upload_mission(mission_items_vec);
    ...
    grpc::Status SubscribeMissionProgress(grpc::ServerContext* /* context */, const mavsdk::rpc::mission_raw::SubscribeMissionProgressRequest* request, grpc::ServerWriter<rpc::mission_raw::MissionProgressResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_mission_progress(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const mavsdk::MissionRaw::MissionProgress mission_progress) {
    ...
    grpc::Status SubscribeMissionChanged(grpc::ServerContext* /* context */, const mavsdk::rpc::mission_raw::SubscribeMissionChangedRequest* request, grpc::ServerWriter<rpc::mission_raw::MissionChangedResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_mission_changed(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const bool mission_changed) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_mission_changed(nullptr);
        ...
        rpc::mission_raw::ImportQgroundcontrolMissionResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->import_qgroundcontrol_mission(request->qgc_plan_path());
