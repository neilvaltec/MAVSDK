...
public:
        ...
        rpc::component_information_server::ProvideFloatParamResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->provide_float_param(translateFromRpcFloatParam(request->param()));
    ...
    grpc::Status SubscribeFloatParam(grpc::ServerContext* /* context */, const mavsdk::rpc::component_information_server::SubscribeFloatParamRequest* request, grpc::ServerWriter<rpc::component_information_server::FloatParamResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_float_param(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const mavsdk::ComponentInformationServer::FloatParamUpdate float_param) {
