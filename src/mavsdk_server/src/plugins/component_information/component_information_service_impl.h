...
public:
        ...
        rpc::component_information::AccessFloatParamsResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "AccessFloatParams sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }

        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->access_float_params();
    ...
    grpc::Status SubscribeFloatParam(grpc::ServerContext* /* context */, const mavsdk::rpc::component_information::SubscribeFloatParamRequest* request, grpc::ServerWriter<rpc::component_information::FloatParamResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_float_param(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const mavsdk::ComponentInformation::FloatParamUpdate float_param) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_float_param(nullptr);
