...
public:
        ...
        rpc::geofence::UploadGeofenceResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->upload_geofence(polygons_vec);
        ...
        rpc::geofence::ClearGeofenceResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "ClearGeofence sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->clear_geofence();
