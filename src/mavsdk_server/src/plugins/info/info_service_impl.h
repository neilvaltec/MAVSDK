...
public:
        ...
        rpc::info::GetFlightInformationResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "GetFlightInformation sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }

        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->get_flight_information();
        ...
        rpc::info::GetIdentificationResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "GetIdentification sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }

        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->get_identification();
        ...
        rpc::info::GetProductResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "GetProduct sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }

        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->get_product();
        ...
        rpc::info::GetVersionResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "GetVersion sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }

        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->get_version();
        ...
        rpc::info::GetSpeedFactorResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "GetSpeedFactor sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }

        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->get_speed_factor();
