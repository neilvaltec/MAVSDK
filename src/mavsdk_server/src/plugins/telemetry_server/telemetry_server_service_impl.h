...
public:
        ...
        rpc::telemetry_server::PublishPositionResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->publish_position(translateFromRpcPosition(request->position()), translateFromRpcVelocityNed(request->velocity_ned()), translateFromRpcHeading(request->heading()));
        ...
        rpc::telemetry_server::PublishHomeResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->publish_home(translateFromRpcPosition(request->home()));
        ...
        rpc::telemetry_server::PublishSysStatusResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->publish_sys_status(translateFromRpcBattery(request->battery()), request->rc_receiver_status(), request->gyro_status(), request->accel_status(), request->mag_status(), request->gps_status());
        ...
        rpc::telemetry_server::PublishExtendedSysStateResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->publish_extended_sys_state(translateFromRpcVtolState(request->vtol_state()), translateFromRpcLandedState(request->landed_state()));
        ...
        rpc::telemetry_server::PublishRawGpsResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->publish_raw_gps(translateFromRpcRawGps(request->raw_gps()), translateFromRpcGpsInfo(request->gps_info()));
        ...
        rpc::telemetry_server::PublishBatteryResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->publish_battery(translateFromRpcBattery(request->battery()));
        ...
        rpc::telemetry_server::PublishStatusTextResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->publish_status_text(translateFromRpcStatusText(request->status_text()));
        ...
        rpc::telemetry_server::PublishOdometryResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->publish_odometry(translateFromRpcOdometry(request->odometry()));
        ...
        rpc::telemetry_server::PublishPositionVelocityNedResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->publish_position_velocity_ned(translateFromRpcPositionVelocityNed(request->position_velocity_ned()));
        ...
        rpc::telemetry_server::PublishGroundTruthResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->publish_ground_truth(translateFromRpcGroundTruth(request->ground_truth()));
        ...
        rpc::telemetry_server::PublishImuResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->publish_imu(translateFromRpcImu(request->imu()));
        ...
        rpc::telemetry_server::PublishScaledImuResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->publish_scaled_imu(translateFromRpcImu(request->imu()));
        ...
        rpc::telemetry_server::PublishRawImuResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->publish_raw_imu(translateFromRpcImu(request->imu()));
        ...
        rpc::telemetry_server::PublishUnixEpochTimeResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->publish_unix_epoch_time(request->time_us());
