...
public:
        ...
        rpc::shell::SendResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->send(request->command());
    ...
    grpc::Status SubscribeReceive(grpc::ServerContext* /* context */, const mavsdk::rpc::shell::SubscribeReceiveRequest* request, grpc::ServerWriter<rpc::shell::ReceiveResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_receive(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const std::string receive) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_receive(nullptr);
