...
public:
    ...
    grpc::Status SubscribeArmDisarm(grpc::ServerContext* /* context */, const mavsdk::rpc::action_server::SubscribeArmDisarmRequest* request, grpc::ServerWriter<rpc::action_server::ArmDisarmResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_arm_disarm(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](mavsdk::ActionServer::Result result,const mavsdk::ActionServer::ArmDisarm arm_disarm) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_arm_disarm(nullptr);
    ...
    grpc::Status SubscribeFlightModeChange(grpc::ServerContext* /* context */, const mavsdk::rpc::action_server::SubscribeFlightModeChangeRequest* request, grpc::ServerWriter<rpc::action_server::FlightModeChangeResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_flight_mode_change(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](mavsdk::ActionServer::Result result,const mavsdk::ActionServer::FlightMode flight_mode_change) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_flight_mode_change(nullptr);
    ...
    grpc::Status SubscribeTakeoff(grpc::ServerContext* /* context */, const mavsdk::rpc::action_server::SubscribeTakeoffRequest* request, grpc::ServerWriter<rpc::action_server::TakeoffResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_takeoff(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](mavsdk::ActionServer::Result result,const bool takeoff) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_takeoff(nullptr);
    ...
    grpc::Status SubscribeLand(grpc::ServerContext* /* context */, const mavsdk::rpc::action_server::SubscribeLandRequest* request, grpc::ServerWriter<rpc::action_server::LandResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_land(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](mavsdk::ActionServer::Result result,const bool land) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_land(nullptr);
    ...
    grpc::Status SubscribeReboot(grpc::ServerContext* /* context */, const mavsdk::rpc::action_server::SubscribeRebootRequest* request, grpc::ServerWriter<rpc::action_server::RebootResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_reboot(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](mavsdk::ActionServer::Result result,const bool reboot) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_reboot(nullptr);
    ...
    grpc::Status SubscribeShutdown(grpc::ServerContext* /* context */, const mavsdk::rpc::action_server::SubscribeShutdownRequest* request, grpc::ServerWriter<rpc::action_server::ShutdownResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_shutdown(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](mavsdk::ActionServer::Result result,const bool shutdown) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_shutdown(nullptr);
    ...
    grpc::Status SubscribeTerminate(grpc::ServerContext* /* context */, const mavsdk::rpc::action_server::SubscribeTerminateRequest* request, grpc::ServerWriter<rpc::action_server::TerminateResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_terminate(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](mavsdk::ActionServer::Result result,const bool terminate) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_terminate(nullptr);
        ...
        rpc::action_server::SetAllowTakeoffResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_allow_takeoff(request->allow_takeoff());
        ...
        rpc::action_server::SetArmableResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_armable(request->armable(), request->force_armable());
        ...
        rpc::action_server::SetDisarmableResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_disarmable(request->disarmable(), request->force_disarmable());
        ...
        rpc::action_server::SetAllowableFlightModesResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_allowable_flight_modes(translateFromRpcAllowableFlightModes(request->flight_modes()));
        ...
        rpc::action_server::GetAllowableFlightModesResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "GetAllowableFlightModes sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }

        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->get_allowable_flight_modes();
