...
public:
        ...
        rpc::camera::PrepareResponse* response) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "Prepare sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->prepare();
        ...
        rpc::camera::TakePhotoResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->take_photo();
        ...
        rpc::camera::StartPhotoIntervalResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->start_photo_interval(request->interval_s());
        ...
        rpc::camera::StopPhotoIntervalResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->stop_photo_interval();
        ...
        rpc::camera::StartVideoResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->start_video();
        ...
        rpc::camera::StopVideoResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->stop_video();
        ...
        rpc::camera::StartVideoStreamingResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->start_video_streaming();
        ...
        rpc::camera::StopVideoStreamingResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->stop_video_streaming();
        ...
        rpc::camera::SetModeResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_mode(translateFromRpcMode(request->mode()));
        ...
        rpc::camera::ListPhotosResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->list_photos(translateFromRpcPhotosRange(request->photos_range()));
    ...
    grpc::Status SubscribeMode(grpc::ServerContext* /* context */, const mavsdk::rpc::camera::SubscribeModeRequest* request, grpc::ServerWriter<rpc::camera::ModeResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_mode(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const mavsdk::Camera::Mode mode) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_mode(nullptr);
    ...
    grpc::Status SubscribeInformation(grpc::ServerContext* /* context */, const mavsdk::rpc::camera::SubscribeInformationRequest* request, grpc::ServerWriter<rpc::camera::InformationResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_information(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const mavsdk::Camera::Information information) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_information(nullptr);
    ...
    grpc::Status SubscribeVideoStreamInfo(grpc::ServerContext* /* context */, const mavsdk::rpc::camera::SubscribeVideoStreamInfoRequest* request, grpc::ServerWriter<rpc::camera::VideoStreamInfoResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_video_stream_info(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const mavsdk::Camera::VideoStreamInfo video_stream_info) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_video_stream_info(nullptr);
    ...
    grpc::Status SubscribeCaptureInfo(grpc::ServerContext* /* context */, const mavsdk::rpc::camera::SubscribeCaptureInfoRequest* request, grpc::ServerWriter<rpc::camera::CaptureInfoResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_capture_info(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const mavsdk::Camera::CaptureInfo capture_info) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_capture_info(nullptr);
    ...
    grpc::Status SubscribeStatus(grpc::ServerContext* /* context */, const mavsdk::rpc::camera::SubscribeStatusRequest* request, grpc::ServerWriter<rpc::camera::StatusResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_status(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const mavsdk::Camera::Status status) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_status(nullptr);
    ...
    grpc::Status SubscribeCurrentSettings(grpc::ServerContext* /* context */, const mavsdk::rpc::camera::SubscribeCurrentSettingsRequest* request, grpc::ServerWriter<rpc::camera::CurrentSettingsResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_current_settings(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const std::vector<mavsdk::Camera::Setting> current_settings) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_current_settings(nullptr);
    ...
    grpc::Status SubscribePossibleSettingOptions(grpc::ServerContext* /* context */, const mavsdk::rpc::camera::SubscribePossibleSettingOptionsRequest* request, grpc::ServerWriter<rpc::camera::PossibleSettingOptionsResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_possible_setting_options(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const std::vector<mavsdk::Camera::SettingOptions> possible_setting_options) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_possible_setting_options(nullptr);
        ...
        rpc::camera::SetSettingResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_setting(translateFromRpcSetting(request->setting()));
        ...
        rpc::camera::GetSettingResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->get_setting(translateFromRpcSetting(request->setting()));
        ...
        rpc::camera::FormatStorageResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->format_storage();
        ...
        rpc::camera::SelectCameraResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->select_camera(request->camera_id());
