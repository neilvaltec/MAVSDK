...
public:
        ...
        rpc::mocap::SetVisionPositionEstimateResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_vision_position_estimate(translateFromRpcVisionPositionEstimate(request->vision_position_estimate()));
        ...
        rpc::mocap::SetAttitudePositionMocapResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_attitude_position_mocap(translateFromRpcAttitudePositionMocap(request->attitude_position_mocap()));
        ...
        rpc::mocap::SetOdometryResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->set_odometry(translateFromRpcOdometry(request->odometry()));
