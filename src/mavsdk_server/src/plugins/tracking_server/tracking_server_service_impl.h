...
public:
        ...
        rpc::tracking_server::SetTrackingPointStatusResponse* /* response */) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->set_tracking_point_status(translateFromRpcTrackPoint(request->tracked_point()));
        ...
        rpc::tracking_server::SetTrackingRectangleStatusResponse* /* response */) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->set_tracking_rectangle_status(translateFromRpcTrackRectangle(request->tracked_rectangle()));
        ...
        rpc::tracking_server::SetTrackingOffStatusResponse* /* response */) override
    {
        ...
        if (request == nullptr) {
            LogWarn() << "SetTrackingOffStatus sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        
        _lazy_plugin.maybe_plugin(request->drone_id())->set_tracking_off_status();
    ...
    grpc::Status SubscribeTrackingPointCommand(grpc::ServerContext* /* context */, const mavsdk::rpc::tracking_server::SubscribeTrackingPointCommandRequest* request, grpc::ServerWriter<rpc::tracking_server::TrackingPointCommandResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_tracking_point_command(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const mavsdk::TrackingServer::TrackPoint tracking_point_command) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_tracking_point_command(nullptr);
    ...
    grpc::Status SubscribeTrackingRectangleCommand(grpc::ServerContext* /* context */, const mavsdk::rpc::tracking_server::SubscribeTrackingRectangleCommandRequest* request, grpc::ServerWriter<rpc::tracking_server::TrackingRectangleCommandResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_tracking_rectangle_command(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const mavsdk::TrackingServer::TrackRectangle tracking_rectangle_command) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_tracking_rectangle_command(nullptr);
    ...
    grpc::Status SubscribeTrackingOffCommand(grpc::ServerContext* /* context */, const mavsdk::rpc::tracking_server::SubscribeTrackingOffCommandRequest* request, grpc::ServerWriter<rpc::tracking_server::TrackingOffCommandResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_tracking_off_command(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, request](const int32_t tracking_off_command) {
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin(request->drone_id())->subscribe_tracking_off_command(nullptr);
        ...
        rpc::tracking_server::RespondTrackingPointCommandResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->respond_tracking_point_command(translateFromRpcCommandAnswer(request->command_answer()));
        ...
        rpc::tracking_server::RespondTrackingRectangleCommandResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->respond_tracking_rectangle_command(translateFromRpcCommandAnswer(request->command_answer()));
        ...
        rpc::tracking_server::RespondTrackingOffCommandResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin(request->drone_id())->respond_tracking_off_command(translateFromRpcCommandAnswer(request->command_answer()));
